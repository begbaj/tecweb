            ...
            <div class="d-flex row mt-3 " style="width: 350px; height: 250px">
                ...
                <div class ="form-outline d-flex align-items-center me-1 mb-3">
                    <div class="row ms-2">
                        ...
                        <div class="d-flex align-items-center pt-1">
                        <?php echo e(Form::checkbox('servizio_in_camera', 'Servizio in Camera', null)); ?>

                        <?php echo e(Form::label('servizio_in_camera', 'Servizio in Camera', ['class' => 'col-sm-auto col-form-label ps-2', 'for' => 'servizio_in_camera'])); ?>
                    ...
                    <div class="row ps-4">
                        ...
                        <div class="d-flex align-items-center pt-1">
                        <?php echo e(Form::checkbox('garage', 'Garage', null)); ?>

                        <?php echo e(Form::label('garage', 'Garage', ['class' => 'col-sm-2 col-form-label ps-2', 'for' => 'garage'])); ?>
