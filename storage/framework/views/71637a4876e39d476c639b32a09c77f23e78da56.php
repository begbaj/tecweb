...
<div class="container py-2 bg-light">
    ...
    <a href="<?php echo e(route('catalog')); ?>" style="text-decoration: none;"> <p class="text-center mt-2 fs-2">Vai al catalogo</p></a>
</div>
<!-- Registrati -->
<div class="container">
    <p class="fs-1 text-center"> Registrati! </p>
    <div class="row align-items-start">    
        <a href="<?php echo e(route('register', ['type' => 'locatore'])); ?>" class="col btn btn-secondary mt-2 me-2">
        ...
        <a href="<?php echo e(route('register',['type' => 'locatario'])); ?>" class="col btn btn-secondary mt-2 me-2">
    ...
    <div class="row">
        <div class="col">
            ...
            <div class="row" style="margin-top: 10em;">
                <a href="<?php echo e(route('faq')); ?>" class="col align-self-end btn btn-primary mt-1 me-2 ms-2">Vai alle FAQs</a>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/tecweb/resources/views/homepage.blade.php ENDPATH**/ ?>