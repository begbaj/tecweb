      ...
      <div class="container text-light">  
        <div class="container bg-transparent mt-5 mb-4 pb-3 pt-5 text-center ">
            ...
            <div class="text-center mt-3">
                <p><small>Non sei ancora registrato? <a href="<?php echo e(route('signin')); ?>">Registrati ora!</a></small></p>
            </div>
        </div>
      </div>    
    </div>
...
<?php echo $__env->make('layouts.public', ['hideLoginForm' => True], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/tecweb/resources/views/login.blade.php ENDPATH**/ ?>